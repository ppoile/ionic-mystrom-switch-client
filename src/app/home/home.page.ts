...
export class HomePage implements OnInit {
  ...
  public onSwitchOn(): void {
    ...
    this.http.get(this.getFullUrl('/relay?state=1'), this._http_options).subscribe((response) => {
  ...
  public onSwitchOff(): void {
    ...
    this.http.get(this.getFullUrl('/relay?state=0'), this._http_options).subscribe((response) => {
  ...
  public onToggle(): void {
    ...
    this.http.get(this.getFullUrl('/toggle'), this._http_options).subscribe((response) => {
  ...
  private getVersion() {
    ...
    this.http.get(this.getFullUrl('/api/v1/info'), this._http_options).subscribe((response) => {
        console.log('response:', response);
